...
export default function App({ practice = false }: { practice?: boolean }) {
  const storagePrefix = practice ? 'hatch-practice' : 'hatch';
  ...
  return <div className={`app-shell${practice ? ' practice-copy' : ''}`}>
